  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-8">
      ...
      <div className="relative max-w-md w-full text-center rounded-3xl 
        border border-white/10 bg-[radial-gradient(circle_at_top,rgba(99,102,241,0.15),rgba(10,10,20,0.9))]
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <div className="w-20 h-20 rounded-2xl 
            ...
            <MessageSquare className="size-10 text-indigo-300" />
          </div>
          ...
          <p className="text-white/60 leading-relaxed">
            ...
            or discover new developers in the Friends section.
          </p>
